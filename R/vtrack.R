...
#'   NULL (sequence) \tab pwm.grad \tab pssm, aggregate, bidirect, prior, extend, spat_* \tab Linearized per-bp gradient (DeepLIFT-style) of the PWM aggregate at the interval start. \cr
