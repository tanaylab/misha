...
#>                    dense_track 
#> "/tmp/RtmpMHZs6a/trackdb/test" 
gtrack.dbs(gtrack.ls(), dataframe = TRUE)
#>                 track                           db
#> 1         array_track /tmp/RtmpMHZs6a/trackdb/test
#> 2         dense_track /tmp/RtmpMHZs6a/trackdb/test
#> 3         rects_track /tmp/RtmpMHZs6a/trackdb/test
#> 4        sparse_track /tmp/RtmpMHZs6a/trackdb/test
#> 5 subdir.dense_track2 /tmp/RtmpMHZs6a/trackdb/test
```
