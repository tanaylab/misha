...
#>                    dense_track 
#> "/tmp/Rtmpw3gJzo/trackdb/test" 
gtrack.dbs(gtrack.ls(), dataframe = TRUE)
#>                 track                           db
#> 1         array_track /tmp/Rtmpw3gJzo/trackdb/test
#> 2         dense_track /tmp/Rtmpw3gJzo/trackdb/test
#> 3         rects_track /tmp/Rtmpw3gJzo/trackdb/test
#> 4        sparse_track /tmp/Rtmpw3gJzo/trackdb/test
#> 5 subdir.dense_track2 /tmp/Rtmpw3gJzo/trackdb/test
```
