...
#>                    dense_track 
#> "/tmp/RtmpigTFOh/trackdb/test" 
gtrack.dbs(gtrack.ls(), dataframe = TRUE)
#>                 track                           db
#> 1         array_track /tmp/RtmpigTFOh/trackdb/test
#> 2         dense_track /tmp/RtmpigTFOh/trackdb/test
#> 3         rects_track /tmp/RtmpigTFOh/trackdb/test
#> 4        sparse_track /tmp/RtmpigTFOh/trackdb/test
#> 5 subdir.dense_track2 /tmp/RtmpigTFOh/trackdb/test
```
