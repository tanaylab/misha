...
Start with the [Misha Basics](https://tanaylab.github.io/misha/articles/Misha-Basics.html) short guide.
...
- [`agent-guides/skills/`](https://github.com/tanaylab/misha/tree/master/agent-guides/skills) - deep playbooks for specific tasks. Currently: [`importing-tracks`](https://github.com/tanaylab/misha/blob/master/agent-guides/skills/importing-tracks/SKILL.md) (format chooser across all `gtrack.*import*` variants + pre/post-import validation). Load when the task specifically calls for one of these.
