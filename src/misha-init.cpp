...
extern "C" {
    ...
    extern SEXP gtrack_create_dense(SEXP, SEXP, SEXP, SEXP, SEXP, SEXP);
    ...
    extern SEXP C_glm_batch_quantiles(SEXP, SEXP, SEXP, SEXP, SEXP, SEXP, SEXP);
}
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"gtrack_create_dense", (DL_FUNC)&gtrack_create_dense, 6},
    ...
    {"C_glm_batch_quantiles", (DL_FUNC)&C_glm_batch_quantiles, 7},
    {NULL, NULL, 0}
};
