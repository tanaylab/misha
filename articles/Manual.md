...
gdataset.ls()
#> [1] "/tmp/RtmpNhKpKb/trackdb/test"       "/tmp/RtmpNhKpKb/shared_annotations"

# Get detailed information
gdataset.ls(dataframe = TRUE)
#>                                 path tracks_total tracks_visible
#> 1       /tmp/RtmpNhKpKb/trackdb/test            5              5
#> 2 /tmp/RtmpNhKpKb/shared_annotations            1              1
...
#> Error:
#> ! Cannot load dataset '/tmp/RtmpNhKpKb/other_dataset':
#>   - tracks 'dense_track' already exist in working database '/tmp/RtmpNhKpKb/trackdb/test'
...
#> [1] "/tmp/RtmpNhKpKb/shared_annotations"

# All sources containing a track (useful for debugging shadowed tracks)
gtrack.dbs("dense_track")
#>                    dense_track 
#> "/tmp/RtmpNhKpKb/trackdb/test"

# Multiple tracks (vectorized)
gtrack.dataset(c("dense_track", "sparse_track", "annotation_track"))
#> [1] "/tmp/RtmpNhKpKb/trackdb/test"       "/tmp/RtmpNhKpKb/trackdb/test"      
#> [3] "/tmp/RtmpNhKpKb/shared_annotations"
...
#> Created linked database at /tmp/RtmpNhKpKb/my_db (linked to /tmp/RtmpNhKpKb/trackdb/test)
