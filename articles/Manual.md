...
gdataset.ls()
#> [1] "/tmp/Rtmpe0xLAO/trackdb/test"       "/tmp/Rtmpe0xLAO/shared_annotations"

# Get detailed information
gdataset.ls(dataframe = TRUE)
#>                                 path tracks_total tracks_visible
#> 1       /tmp/Rtmpe0xLAO/trackdb/test            5              5
#> 2 /tmp/Rtmpe0xLAO/shared_annotations            1              1
...
#> Error:
#> ! Cannot load dataset '/tmp/Rtmpe0xLAO/other_dataset':
#>   - tracks 'dense_track' already exist in working database '/tmp/Rtmpe0xLAO/trackdb/test'
...
#> [1] "/tmp/Rtmpe0xLAO/shared_annotations"

# All sources containing a track (useful for debugging shadowed tracks)
gtrack.dbs("dense_track")
#>                    dense_track 
#> "/tmp/Rtmpe0xLAO/trackdb/test"

# Multiple tracks (vectorized)
gtrack.dataset(c("dense_track", "sparse_track", "annotation_track"))
#> [1] "/tmp/Rtmpe0xLAO/trackdb/test"       "/tmp/Rtmpe0xLAO/trackdb/test"      
#> [3] "/tmp/Rtmpe0xLAO/shared_annotations"
...
#> Created linked database at /tmp/Rtmpe0xLAO/my_db (linked to /tmp/Rtmpe0xLAO/trackdb/test)
