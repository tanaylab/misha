...
gdataset.ls()
#> [1] "/tmp/Rtmp8mUej3/trackdb/test"       "/tmp/Rtmp8mUej3/shared_annotations"

# Get detailed information
gdataset.ls(dataframe = TRUE)
#>                                 path tracks_total tracks_visible
#> 1       /tmp/Rtmp8mUej3/trackdb/test            5              5
#> 2 /tmp/Rtmp8mUej3/shared_annotations            1              1
...
#> Error:
#> ! Cannot load dataset '/tmp/Rtmp8mUej3/other_dataset':
#>   - tracks 'dense_track' already exist in working database '/tmp/Rtmp8mUej3/trackdb/test'
...
#> [1] "/tmp/Rtmp8mUej3/shared_annotations"

# All sources containing a track (useful for debugging shadowed tracks)
gtrack.dbs("dense_track")
#>                    dense_track 
#> "/tmp/Rtmp8mUej3/trackdb/test"

# Multiple tracks (vectorized)
gtrack.dataset(c("dense_track", "sparse_track", "annotation_track"))
#> [1] "/tmp/Rtmp8mUej3/trackdb/test"       "/tmp/Rtmp8mUej3/trackdb/test"      
#> [3] "/tmp/Rtmp8mUej3/shared_annotations"
...
#> Created linked database at /tmp/Rtmp8mUej3/my_db (linked to /tmp/Rtmp8mUej3/trackdb/test)
