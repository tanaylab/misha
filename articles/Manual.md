...
gdataset.ls()
#> [1] "/tmp/Rtmp1Ga1WC/trackdb/test"       "/tmp/Rtmp1Ga1WC/shared_annotations"

# Get detailed information
gdataset.ls(dataframe = TRUE)
#>                                 path tracks_total tracks_visible
#> 1       /tmp/Rtmp1Ga1WC/trackdb/test            5              5
#> 2 /tmp/Rtmp1Ga1WC/shared_annotations            1              1
...
#> Error:
#> ! Cannot load dataset '/tmp/Rtmp1Ga1WC/other_dataset':
#>   - tracks 'dense_track' already exist in working database '/tmp/Rtmp1Ga1WC/trackdb/test'
...
#> [1] "/tmp/Rtmp1Ga1WC/shared_annotations"

# All sources containing a track (useful for debugging shadowed tracks)
gtrack.dbs("dense_track")
#>                    dense_track 
#> "/tmp/Rtmp1Ga1WC/trackdb/test"

# Multiple tracks (vectorized)
gtrack.dataset(c("dense_track", "sparse_track", "annotation_track"))
#> [1] "/tmp/Rtmp1Ga1WC/trackdb/test"       "/tmp/Rtmp1Ga1WC/trackdb/test"      
#> [3] "/tmp/Rtmp1Ga1WC/shared_annotations"
...
#> Created linked database at /tmp/Rtmp1Ga1WC/my_db (linked to /tmp/Rtmp1Ga1WC/trackdb/test)
