...
gdataset.ls()
#> [1] "/tmp/RtmpevWfzK/trackdb/test"       "/tmp/RtmpevWfzK/shared_annotations"

# Get detailed information
gdataset.ls(dataframe = TRUE)
#>                                 path tracks_total tracks_visible
#> 1       /tmp/RtmpevWfzK/trackdb/test            5              5
#> 2 /tmp/RtmpevWfzK/shared_annotations            1              1
...
#> Error:
#> ! Cannot load dataset '/tmp/RtmpevWfzK/other_dataset':
#>   - tracks 'dense_track' already exist in working database '/tmp/RtmpevWfzK/trackdb/test'
...
#> [1] "/tmp/RtmpevWfzK/shared_annotations"

# All sources containing a track (useful for debugging shadowed tracks)
gtrack.dbs("dense_track")
#>                    dense_track 
#> "/tmp/RtmpevWfzK/trackdb/test"

# Multiple tracks (vectorized)
gtrack.dataset(c("dense_track", "sparse_track", "annotation_track"))
#> [1] "/tmp/RtmpevWfzK/trackdb/test"       "/tmp/RtmpevWfzK/trackdb/test"      
#> [3] "/tmp/RtmpevWfzK/shared_annotations"
...
#> Created linked database at /tmp/RtmpevWfzK/my_db (linked to /tmp/RtmpevWfzK/trackdb/test)
