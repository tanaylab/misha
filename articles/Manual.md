...
gdataset.ls()
#> [1] "/tmp/RtmpCISRIa/trackdb/test"       "/tmp/RtmpCISRIa/shared_annotations"

# Get detailed information
gdataset.ls(dataframe = TRUE)
#>                                 path tracks_total tracks_visible
#> 1       /tmp/RtmpCISRIa/trackdb/test            5              5
#> 2 /tmp/RtmpCISRIa/shared_annotations            1              1
...
#> Error:
#> ! Cannot load dataset '/tmp/RtmpCISRIa/other_dataset':
#>   - tracks 'dense_track' already exist in working database '/tmp/RtmpCISRIa/trackdb/test'
...
#> [1] "/tmp/RtmpCISRIa/shared_annotations"

# All sources containing a track (useful for debugging shadowed tracks)
gtrack.dbs("dense_track")
#>                    dense_track 
#> "/tmp/RtmpCISRIa/trackdb/test"

# Multiple tracks (vectorized)
gtrack.dataset(c("dense_track", "sparse_track", "annotation_track"))
#> [1] "/tmp/RtmpCISRIa/trackdb/test"       "/tmp/RtmpCISRIa/trackdb/test"      
#> [3] "/tmp/RtmpCISRIa/shared_annotations"
...
#> Created linked database at /tmp/RtmpCISRIa/my_db (linked to /tmp/RtmpCISRIa/trackdb/test)
