...
gdataset.ls()
#> [1] "/tmp/RtmphjRTkd/trackdb/test"       "/tmp/RtmphjRTkd/shared_annotations"

# Get detailed information
gdataset.ls(dataframe = TRUE)
#>                                 path tracks_total tracks_visible
#> 1       /tmp/RtmphjRTkd/trackdb/test            5              5
#> 2 /tmp/RtmphjRTkd/shared_annotations            1              1
...
#> Error:
#> ! Cannot load dataset '/tmp/RtmphjRTkd/other_dataset':
#>   - tracks 'dense_track' already exist in working database '/tmp/RtmphjRTkd/trackdb/test'
...
#> [1] "/tmp/RtmphjRTkd/shared_annotations"

# All sources containing a track (useful for debugging shadowed tracks)
gtrack.dbs("dense_track")
#>                    dense_track 
#> "/tmp/RtmphjRTkd/trackdb/test"

# Multiple tracks (vectorized)
gtrack.dataset(c("dense_track", "sparse_track", "annotation_track"))
#> [1] "/tmp/RtmphjRTkd/trackdb/test"       "/tmp/RtmphjRTkd/trackdb/test"      
#> [3] "/tmp/RtmphjRTkd/shared_annotations"
...
#> Created linked database at /tmp/RtmphjRTkd/my_db (linked to /tmp/RtmphjRTkd/trackdb/test)
