...
gdataset.ls()
#> [1] "/tmp/Rtmp130AWX/trackdb/test"       "/tmp/Rtmp130AWX/shared_annotations"

# Get detailed information
gdataset.ls(dataframe = TRUE)
#>                                 path tracks_total tracks_visible
#> 1       /tmp/Rtmp130AWX/trackdb/test            5              5
#> 2 /tmp/Rtmp130AWX/shared_annotations            1              1
...
#> Error:
#> ! Cannot load dataset '/tmp/Rtmp130AWX/other_dataset':
#>   - tracks 'dense_track' already exist in working database '/tmp/Rtmp130AWX/trackdb/test'
...
#> [1] "/tmp/Rtmp130AWX/shared_annotations"

# All sources containing a track (useful for debugging shadowed tracks)
gtrack.dbs("dense_track")
#>                    dense_track 
#> "/tmp/Rtmp130AWX/trackdb/test"

# Multiple tracks (vectorized)
gtrack.dataset(c("dense_track", "sparse_track", "annotation_track"))
#> [1] "/tmp/Rtmp130AWX/trackdb/test"       "/tmp/Rtmp130AWX/trackdb/test"      
#> [3] "/tmp/Rtmp130AWX/shared_annotations"
...
#> Created linked database at /tmp/Rtmp130AWX/my_db (linked to /tmp/Rtmp130AWX/trackdb/test)
