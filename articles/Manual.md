...
gdataset.ls()
#> [1] "/tmp/RtmptCVDmW/trackdb/test"       "/tmp/RtmptCVDmW/shared_annotations"

# Get detailed information
gdataset.ls(dataframe = TRUE)
#>                                 path tracks_total tracks_visible
#> 1       /tmp/RtmptCVDmW/trackdb/test            5              5
#> 2 /tmp/RtmptCVDmW/shared_annotations            1              1
...
#> Error:
#> ! Cannot load dataset '/tmp/RtmptCVDmW/other_dataset':
#>   - tracks 'dense_track' already exist in working database '/tmp/RtmptCVDmW/trackdb/test'
...
#> [1] "/tmp/RtmptCVDmW/shared_annotations"

# All sources containing a track (useful for debugging shadowed tracks)
gtrack.dbs("dense_track")
#>                    dense_track 
#> "/tmp/RtmptCVDmW/trackdb/test"

# Multiple tracks (vectorized)
gtrack.dataset(c("dense_track", "sparse_track", "annotation_track"))
#> [1] "/tmp/RtmptCVDmW/trackdb/test"       "/tmp/RtmptCVDmW/trackdb/test"      
#> [3] "/tmp/RtmptCVDmW/shared_annotations"
...
#> Created linked database at /tmp/RtmptCVDmW/my_db (linked to /tmp/RtmptCVDmW/trackdb/test)
