...
gdataset.ls()
#> [1] "/tmp/RtmpI6KBL4/trackdb/test"       "/tmp/RtmpI6KBL4/shared_annotations"

# Get detailed information
gdataset.ls(dataframe = TRUE)
#>                                 path tracks_total tracks_visible
#> 1       /tmp/RtmpI6KBL4/trackdb/test            5              5
#> 2 /tmp/RtmpI6KBL4/shared_annotations            1              1
...
#> Error:
#> ! Cannot load dataset '/tmp/RtmpI6KBL4/other_dataset':
#>   - tracks 'dense_track' already exist in working database '/tmp/RtmpI6KBL4/trackdb/test'
...
#> [1] "/tmp/RtmpI6KBL4/shared_annotations"

# All sources containing a track (useful for debugging shadowed tracks)
gtrack.dbs("dense_track")
#>                    dense_track 
#> "/tmp/RtmpI6KBL4/trackdb/test"

# Multiple tracks (vectorized)
gtrack.dataset(c("dense_track", "sparse_track", "annotation_track"))
#> [1] "/tmp/RtmpI6KBL4/trackdb/test"       "/tmp/RtmpI6KBL4/trackdb/test"      
#> [3] "/tmp/RtmpI6KBL4/shared_annotations"
...
#> Created linked database at /tmp/RtmpI6KBL4/my_db (linked to /tmp/RtmpI6KBL4/trackdb/test)
