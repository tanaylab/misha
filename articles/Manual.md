...
gdataset.ls()
#> [1] "/tmp/RtmpL9A4kw/trackdb/test"       "/tmp/RtmpL9A4kw/shared_annotations"

# Get detailed information
gdataset.ls(dataframe = TRUE)
#>                                 path tracks_total tracks_visible
#> 1       /tmp/RtmpL9A4kw/trackdb/test            5              5
#> 2 /tmp/RtmpL9A4kw/shared_annotations            1              1
...
#> Error:
#> ! Cannot load dataset '/tmp/RtmpL9A4kw/other_dataset':
#>   - tracks 'dense_track' already exist in working database '/tmp/RtmpL9A4kw/trackdb/test'
...
#> [1] "/tmp/RtmpL9A4kw/shared_annotations"

# All sources containing a track (useful for debugging shadowed tracks)
gtrack.dbs("dense_track")
#>                    dense_track 
#> "/tmp/RtmpL9A4kw/trackdb/test"

# Multiple tracks (vectorized)
gtrack.dataset(c("dense_track", "sparse_track", "annotation_track"))
#> [1] "/tmp/RtmpL9A4kw/trackdb/test"       "/tmp/RtmpL9A4kw/trackdb/test"      
#> [3] "/tmp/RtmpL9A4kw/shared_annotations"
...
#> Created linked database at /tmp/RtmpL9A4kw/my_db (linked to /tmp/RtmpL9A4kw/trackdb/test)
