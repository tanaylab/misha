...
gdataset.ls()
#> [1] "/tmp/Rtmp3hioNR/trackdb/test"       "/tmp/Rtmp3hioNR/shared_annotations"

# Get detailed information
gdataset.ls(dataframe = TRUE)
#>                                 path tracks_total tracks_visible
#> 1       /tmp/Rtmp3hioNR/trackdb/test            5              5
#> 2 /tmp/Rtmp3hioNR/shared_annotations            1              1
...
#> Error:
#> ! Cannot load dataset '/tmp/Rtmp3hioNR/other_dataset':
#>   - tracks 'dense_track' already exist in working database '/tmp/Rtmp3hioNR/trackdb/test'
...
#> [1] "/tmp/Rtmp3hioNR/shared_annotations"

# All sources containing a track (useful for debugging shadowed tracks)
gtrack.dbs("dense_track")
#>                    dense_track 
#> "/tmp/Rtmp3hioNR/trackdb/test"

# Multiple tracks (vectorized)
gtrack.dataset(c("dense_track", "sparse_track", "annotation_track"))
#> [1] "/tmp/Rtmp3hioNR/trackdb/test"       "/tmp/Rtmp3hioNR/trackdb/test"      
#> [3] "/tmp/Rtmp3hioNR/shared_annotations"
...
#> Created linked database at /tmp/Rtmp3hioNR/my_db (linked to /tmp/Rtmp3hioNR/trackdb/test)
