...
gdataset.ls()
#> [1] "/tmp/Rtmp91XyOm/trackdb/test"       "/tmp/Rtmp91XyOm/shared_annotations"

# Get detailed information
gdataset.ls(dataframe = TRUE)
#>                                 path tracks_total tracks_visible
#> 1       /tmp/Rtmp91XyOm/trackdb/test            5              5
#> 2 /tmp/Rtmp91XyOm/shared_annotations            1              1
...
#> Error:
#> ! Cannot load dataset '/tmp/Rtmp91XyOm/other_dataset':
#>   - tracks 'dense_track' already exist in working database '/tmp/Rtmp91XyOm/trackdb/test'
...
#> [1] "/tmp/Rtmp91XyOm/shared_annotations"

# All sources containing a track (useful for debugging shadowed tracks)
gtrack.dbs("dense_track")
#>                    dense_track 
#> "/tmp/Rtmp91XyOm/trackdb/test"

# Multiple tracks (vectorized)
gtrack.dataset(c("dense_track", "sparse_track", "annotation_track"))
#> [1] "/tmp/Rtmp91XyOm/trackdb/test"       "/tmp/Rtmp91XyOm/trackdb/test"      
#> [3] "/tmp/Rtmp91XyOm/shared_annotations"
...
#> Created linked database at /tmp/Rtmp91XyOm/my_db (linked to /tmp/Rtmp91XyOm/trackdb/test)
